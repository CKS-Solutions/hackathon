...
variable "cluster_access_principal_arns" {
  ...
  type        = list(string)
  default     = ["arn:aws:iam::027653366477:user/kenzo", "arn:aws:iam::027653366477:user/kenzo-console", "arn:aws:iam::027653366477:user/github_deploy", "arn:aws:iam::027653366477:user/kath"]
}
